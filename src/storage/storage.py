...
class Storage:
    def __init__(self, database_directory_name: str = 'data',
                 database_file_name: str = 'data.db') -> None:
        self.database_directory_name = database_directory_name
        self.file_name = database_directory_name + '/' + database_file_name
    ...
    def create_tables_query(self) -> str:
        ...
        query: str = f"""
                        ...
                        (
                            ...
                            {d.datetime.value} text,
                            {d.year.value} integer,
                            {d.month.value} integer,
                            {d.day.value} integer,
                            {d.hours.value} integer,
                            {d.minutes.value} integer,
